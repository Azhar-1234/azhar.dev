...
export default function Plugins() {
  return (
    <section id="plugins" className="bg-cream-dark px-16 py-[88px]">
      <div className="mx-auto max-w-[1180px]">
        <div className="font-mono text-[13px] font-medium text-rust">03 — PLUGINS</div>
        <h2 className="mt-3.5 mb-3 font-display text-[44px] font-bold tracking-tight">
          Plugins I&apos;ve built &amp; shipped
        </h2>
        <p className="mb-12 max-w-[620px] text-[17px] leading-relaxed text-[#57534E]">
        ...
        <div className="grid grid-cols-3 gap-6">
          {plugins.map((pl) => (
            <div
              key={pl.name}
              className="flex flex-col gap-3.5 rounded-2xl border border-border bg-cream-light p-[30px] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(28,25,23,0.10)]"
            >
        ...
        <div className="mt-10 rounded-2xl border border-gold bg-[#F7F0E2] px-9 py-8">
